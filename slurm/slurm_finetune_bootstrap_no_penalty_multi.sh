...
#SBATCH --mem=64G
#SBATCH --array=0-2
#SBATCH --output=/gpfs/work4/0/prjs0951/Giacomo/robotic_world_model/logs/slurm/ft-bs-nopen-%A_%a.out
#SBATCH --error=/gpfs/work4/0/prjs0951/Giacomo/robotic_world_model/logs/slurm/ft-bs-nopen-%A_%a.err

# =============================================================================
# Finetune: Bootstrap Ensemble, NO Uncertainty Penalty (3 Seeds)
# =============================================================================
# Loads from: Bootstrap pretrain (slurm_pretrain_rwm_ensemble_multi.sh)
# Config: uncertainty_penalty = 0.0
# =============================================================================
...
UNCERTAINTY_PENALTY=0.0  # NO PENALTY
UNCERTAINTY_METRIC="std"

# Logging
LOGGER="tensorboard"
WANDB_PROJECT="rwm-anymal"
RUN_NAME="finetune-bs-nopen-seed${SEED}"
